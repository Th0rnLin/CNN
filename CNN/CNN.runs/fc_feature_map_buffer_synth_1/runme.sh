...
HD_PWD='E:/Zedboard/CNN/CNN/CNN.runs/fc_feature_map_buffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fc_feature_map_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fc_feature_map_buffer.tcl

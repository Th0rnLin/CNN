...
HD_PWD='E:/Zedboard/CNN/CNN/CNN.runs/fc_mult_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fc_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fc_mult.tcl

...
HD_PWD='E:/Zedboard/CNN/CNN/CNN.runs/conv_mult_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conv_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv_mult.tcl
